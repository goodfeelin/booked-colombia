...
export const LISTINGS: Listing[] = [
  ...
  {
    id: 'student-loft-chapinero',
    title: 'Chapinero Student Photo Loft',
    city: 'Bogotá', neighborhood: 'Chapinero', type: 'Studio',
    hourlyCop: 75000, halfDayCop: 280000, fullDayCop: 480000, cleaningFeeCop: 25000,
    minHours: 2, maxCrew: 4, rating: 4.78, reviewCount: 33,
    image: bogotaLoft, gallery: [bogotaLoft, laureles, poblado],
    badges: ['Affordable', 'Instant Request'],
    amenities: ['Natural light','Power access','High-speed Wi-Fi','Bathroom','Makeup room'],
    description: 'A small, bright photo studio perfect for students, indie creators and personal-brand shoots. Two backdrops included, hourly rates that respect a tight budget.',
    rules: ['No food on backdrops','Reset furniture before leaving'],
    host: baseHost('Laura Beltrán'),
    details: {
      naturalLight: 'Good', bestLightHours: '10am–2pm', noise: 'Quiet', elevator: true,
      parking: 'Street', powerOutlets: '110V, 8 outlets', wifi: '200 Mbps',
      bathrooms: 1, makeupArea: true, furnitureMovable: true, nightShoots: false, drone: false,
      pets: false, smoking: 'Not allowed', security: 'Building access',
    },
    productionTypes: ['Photography','Social media content','Product shoot','Podcast','Interview'],
    styleTags: ['Bright','Minimal','Beginner-friendly','Budget'],
  },
  {
    id: 'cali-creator-house',
    title: 'Cali Creator House — Tropical Patio',
    city: 'Cali', neighborhood: 'San Antonio', type: 'House',
    hourlyCop: 110000, halfDayCop: 400000, fullDayCop: 720000, cleaningFeeCop: 40000,
    minHours: 2, maxCrew: 8, rating: 4.83, reviewCount: 41,
    image: laureles, gallery: [laureles, finca, cartagena],
    badges: ['Affordable', 'Great Natural Light'],
    amenities: ['Natural light','Outdoor area','Kitchen','Bathroom','High-speed Wi-Fi','Power access'],
    description: 'A colorful Caleño creator house with a tropical patio, vintage furniture and warm afternoon light. Mid-range pricing for indie creators, dancers and music content.',
    rules: ['Respect siesta hours','Clean kitchen after use','No fireworks'],
    host: baseHost('Esteban Lozano'),
    details: {
      naturalLight: 'Excellent', bestLightHours: '3–6pm', noise: 'Moderate', elevator: false,
      parking: 'Street + 1 spot', powerOutlets: '110V, 12 outlets', wifi: '300 Mbps',
      bathrooms: 2, makeupArea: false, furnitureMovable: true, nightShoots: true, drone: false,
      pets: true, smoking: 'Outdoor only', security: 'Neighborhood watch',
    },
    productionTypes: ['Social media content','Music video','Photography','Commercial','Fashion editorial'],
    styleTags: ['Tropical','Colorful','Vintage','Mid-range'],
  },
  {
    id: 'medellin-warehouse',
    title: 'Medellín Industrial Warehouse',
    city: 'Medellín', neighborhood: 'Belén', type: 'Warehouse',
    hourlyCop: 140000, halfDayCop: 520000, fullDayCop: 920000, cleaningFeeCop: 45000,
    minHours: 3, maxCrew: 20, rating: 4.81, reviewCount: 28,
    image: bogotaLoft, gallery: [bogotaLoft, rooftop, poblado],
    badges: ['Affordable', 'Music Video Friendly'],
    amenities: ['Power access','Loading access','Blackout capability','Bathroom','Parking','Air conditioning'],
    description: 'A 400m² blank-canvas warehouse with truck access, three-phase power and full blackout. Built for music videos, dance, set construction and large product shoots — without premium pricing.',
    rules: ['Restore set after use','No open flames without permit','Truck unloading 7am–8pm'],
    host: baseHost('Juan Pablo Arango'),
    details: {
      naturalLight: 'Controlled', bestLightHours: 'N/A — full blackout', noise: 'Moderate', elevator: false,
      parking: '8 spots + truck bay', powerOutlets: '3-phase, 50A', wifi: '200 Mbps',
      bathrooms: 2, makeupArea: true, furnitureMovable: true, nightShoots: true, drone: false,
      pets: false, smoking: 'Outdoor only', security: 'CCTV + guard at night',
    },
    productionTypes: ['Music video','Film','Commercial','Product shoot','Event content'],
    styleTags: ['Industrial','Blackbox','Versatile','Crew-friendly'],
  },
];
